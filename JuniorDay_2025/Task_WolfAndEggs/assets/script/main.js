...
let intervalSpeed
let isPlay = false;
let musicSrcArray = ['../../assets/music/1.mp3', '../../assets/music/02.mp3', '../../assets/music/03.mp3', '../../assets/music/04.mp3', '../../assets/music/5.mp3']
...
function updateLeaderTable() {
    ...
    localStorage.setItem('1eaderTableArray', JSON.stringify(players))
}
...
function chooseDifficulty(currentPlayer) {
    ...
    let hard = document.querySelector('.easy');
    let medium = document.querySelector('.medium');
    let easy = document.querySelector('.hard');
